            ...
            <section className="py-12 md:py-24 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
                <div className="container px-4 md:px-6 mx-auto">
                    <FadeIn className="max-w-4xl mx-auto">
                        ...
                        <ScaleIn className="bg-background p-8 md:p-12 rounded-2xl shadow-xl border-l-4 border-primary relative">
            ...
            <section className="py-12 md:py-24">
                <div className="container px-4 md:px-6 mx-auto">
                    ...
                    <FadeIn delay={0.3}>
                        ...
                        <StaggerContainer className="grid lg:grid-cols-2 gap-12 mb-16">
                            {/* Bank Transfer */}
                            <StaggerItem className="space-y-6">
                                <h3 className="text-2xl font-bold flex items-center gap-2">
                                    <Landmark className="h-6 w-6 text-primary" /> Bank Transfer
                                </h3>
                                <div className="bg-muted/50 p-6 rounded-xl border hover:shadow-md transition-shadow">
...
function ImpactCard({ amount, description }: { amount: string, description: string }) {
    return (
        <div className="bg-background p-6 rounded-xl shadow-lg border-t-4 border-secondary hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
...
function GivingStrategyCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
    return (
        <div className="bg-background p-6 rounded-xl shadow-sm border hover:border-primary/50 hover:shadow-md transition-all">
