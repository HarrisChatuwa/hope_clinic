  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 md:py-24 lg:py-32">
        <FadeIn className="container px-4 md:px-6 mx-auto text-center max-w-3xl space-y-4">
      ...
      <section className="py-12 md:py-24 lg:py-32 bg-secondary text-secondary-foreground">
        <FadeIn className="container px-4 md:px-6 mx-auto text-center space-y-6">
...
function ServiceCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="flex flex-col items-center text-center p-6 bg-background rounded-lg shadow-sm border hover:shadow-lg hover:scale-105 transition-all duration-300">
